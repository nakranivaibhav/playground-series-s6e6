"""node_0032 — improve (nn): RealMLP seed-2 bag (SEED=137 vs node_0028's SEED=42).

Built on: node_0028 (RealMLP reference recipe, cv 0.969065) — all code BYTE-IDENTICAL
except the global SEED constant (42 → 137) and any seed derived from it.
Purpose: a 2nd independent RealMLP run to bag with node_0028 (averaging 2 seeds
