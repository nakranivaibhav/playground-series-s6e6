"""node_0035 — improve (nn): RealMLP seed-3 bag (SEED=2024 vs node_0028's SEED=42 and node_0032's SEED=137).

Built on: node_0028 (RealMLP reference recipe, cv 0.969065).
Everything is byte-identical to node_0028 except the global SEED constant (42 → 2024)
and any seed derived from it. This produces a 3rd distinct OOF/test_probs for bagging
with node_0028 + node_0032 into a 3-seed RealMLP bag.

THE ONE ATOMIC CHANGE:
  SEED = 42 → SEED = 2024 (the ONLY edit; architecture, FE, preprocessing, n_ens, epochs unchanged).

Original node_0028 note for reference:
