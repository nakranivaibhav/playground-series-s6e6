...
def main():
    ...
    print("\n" + "="*70, flush=True)
    print("=== BROAD REVIVAL FORWARD-SELECT: ALL never-pooled single-model bases under C0.003 ===", flush=True)
    # Every valid never-pooled SINGLE-MODEL base (family nn/gbdt, NOT derivative stacks):
    #  14 our-own FT-T · 71 5-seed DCN · 75 5-seed TabM · 86 z-resid TabM · 87 z-resid LGBM
    #  90 OvR chain · 94 error-pocket GBDT · 98 RBF base
    STUDENTS = [14, 71, 75, 86, 87, 90, 94, 98]
    student_logp = {}
    for sid in STUDENTS:
        nm = f"node_{sid:04d}"
